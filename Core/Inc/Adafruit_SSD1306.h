...
class Adafruit_SSD1306 : public Adafruit_GFX {
 public:
  ...
  void sh1106_begin(uint8_t switchvcc = SSD1306_SWITCHCAPVCC, uint8_t i2caddr = SSD1306_I2C_ADDRESS, bool reset = true);

  void clear(uint8_t ch);

  void ssd1306_command(uint8_t c);
  void ssd1306_data(uint16_t a);
  void sh1106_data(uint16_t a);

  void clearDisplay(void);
  void clearDisplay_sh1106(void);
